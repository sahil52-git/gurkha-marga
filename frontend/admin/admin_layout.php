...
.modal{
    ...
    padding:1.5rem;width:100%;max-width:540px;max-height:92vh;overflow-y:auto;
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sb-nav">
        ...
        <a href="admin_logout.php" class="nav-link danger" onclick="return confirm('Log out of admin panel?')">
